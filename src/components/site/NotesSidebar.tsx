  ...
  return (
    <aside className="hidden w-72 shrink-0 border-r border-[rgba(255,255,255,0.04)] bg-[var(--neu-surface)] p-3 lg:block">
      <div className="neu-inset mb-3 px-3 py-2.5">
        <p className="text-[11px] uppercase tracking-wide text-[rgba(100,116,139,0.45)]">
          Sections
        </p>
            ...
            <Link
              ...
              className={`flex items-center gap-2 rounded-xl px-3 py-2 text-[13px] transition ${
                active
                  ...
                  : "text-[rgba(71,85,105,0.7)] hover:bg-[var(--neu-elevated)] hover:text-[var(--foreground)] hover:shadow-[4px_4px_10px_rgba(0,0,0,0.35),-2px_-2px_8px_rgba(255,255,255,0.05)]"
              }`}
            >
      ...
      <div className="neu-inset mt-5 space-y-2 p-3">
        <Link
          href="/#start-here"
          className="neu-chip block rounded-xl px-2.5 py-2 text-center text-[12px] text-[rgba(30,41,59,0.85)]"
        >
          Start here pathway
        </Link>
        <Link
