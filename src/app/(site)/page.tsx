    ...
    <>
      ...
      <div id="start-here" className="neu-inset scroll-mt-28 p-6 sm:p-8">
          ...
          {[
            ...
            <li key={step.href}>
              {step.here ? (
                ...
                <Link
                  href={step.href}
                  className="neu-chip flex items-center gap-3 rounded-xl px-4 py-3 text-[14px] text-[rgba(30,41,59,0.82)] transition hover:text-[var(--foreground)]"
                >
                  <span className="font-mono text-[12px] text-[rgba(100,116,139,0.4)]">
                    {step.n}.
                  </span>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            href="/experience-understanding"
            className="neu-chip inline-flex items-center gap-2 rounded-full px-4 py-2 text-[13px] font-medium text-[rgba(15,23,42,0.9)]"
          >
      ...
      <div className="mt-12 grid gap-6 lg:grid-cols-3">
        <div className="neu-raised p-6">
          ...
          <p className="mt-2 text-[13px] leading-relaxed text-[rgba(100,116,139,0.55)]">
      ...
      <Section title="My MUN journey in one breath">
        ...
        <p>
          ...
          <strong className="text-[rgba(15,23,42,0.92)]">power is procedural as much as rhetorical</strong>
      ...
      <Section title="Who this site is for">
        <ul className="list-disc space-y-2 pl-5 marker:text-[var(--neu-accent)]">
          ...
          <li>
            <strong className="text-[rgba(15,23,42,0.88)]">Experienced delegates</strong> who want
            sharper comparison across committees and stronger evidence habits.
          </li>
          <li>
            <strong className="text-[rgba(15,23,42,0.88)]">Student leaders</strong> designing
