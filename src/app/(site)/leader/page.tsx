...
export default function LeaderPage() {
  return (
    <>
      <PageIntro eyebrow="Page 5 · The bridge" title="From delegate → leader">
        <p>
      ...
      <Section title="Problems I noticed at conferences">
        ...
        <Callout title="Why these problems matter">
      ...
      <Callout title="Level 6 · Experience → Insight → Solution">
        <p className="mb-4">
      ...
      <Section title="How experiences shaped my ideas">
        <p>
